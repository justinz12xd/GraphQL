...
from app.modules.voluntario.interface.graphql_aggregation_query import VoluntarioAggregationQuery
...
from app.reports.routes.aggregation_routes import GeneralAggregationQuery
...
class Query(
    ...
    TipoCampaniaQuery, 
    VoluntarioQuery,
    VoluntarioAggregationQuery,
    SupervisorQuery,
    EspecieQuery,
    RefugioQuery,
    PublicacionQuery,
    SeguimientoQuery,
    GeneralAggregationQuery
):
